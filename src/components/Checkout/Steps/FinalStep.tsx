...
export const FinalStep = () => {
    ...
    return(
        <>
            ...
            <form className={classes.form}>
                <Alert className={classes.alert} title="Wymagana akceptacja regulaminów.">

                    <p style={{color: theme.colors.blue[6]}}>Oświadczam, iż zapoznałem się z  <u>regulaminem serwisu</u> amabilia-meble.pl, <u>Polityką Cookies </u>oraz  <u>Polityką Prywatności</u> i je akceptuję.
                    </p>
